...
#ifndef BOOST_COMPUTE_BLAS_DOT_HPP
#define BOOST_COMPUTE_BLAS_DOT_HPP
                  ...
                  command_queue &queue)
{
    ...
    return ::boost::compute::inner_product(X, X + N, Y, Scalar(0), queue);
}
...
#endif // BOOST_COMPUTE_BLAS_DOT_HPP
